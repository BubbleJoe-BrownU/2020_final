...
```
```{r}
data_wave_2 <- read_dta('/Users/a123/Desktop/FFdata/wave2/FF_wave2_2020v2.dta')
data_wave_1 <- read_dta('/Users/a123/Desktop/FFdata/wave1/FF_wave1_2020v2.dta')
```
...
# in cf2marm, cf2cohm 0 = no)
combined_data_filtered <- combined_data %>%
  filter(cf2md_case_lib >= 0, cf2age >= 0, cm2fbir >= 0, cf2edu >= 0,
...
```{r}
#changing values for m2c33, changing from 201 to 1 (working), 202 to 2(unemployed), 203 to 3( in jail)
